...
<html>
<head>
	<title>Vote+ Security Page</title>
                ...
                <div class="s12 m12 l12">
                    ...
                    <div class="col s8 m3 l4">
                        <div class="card-panel" style="width:500px;">
                            ...
                            <h1 style="color:#263238;margin-left:40px;"> Hello!</h1>
                            <label style="font-size:30px;margin-left:40px;color:#212121;font-family:segoe ui">Choose your Security Question</label> <br> <br>
                            <div class="row" >
                                <label style="font-size:25px;margin-left:40px;margin-bottom:20px;color:#eceff1;font-family:segoe ui">Security Question</label>
                          <select class="browser-default N/A transparent" style="margin-left:40px;font-size:16px;height:40px;width:200px;border-color:#fbc02d;color:#fafafa">
                        ...
                        <div class="row">
                            <div class="input-field col s6lxg tooltipped" data-position="top" data-delay="50" data-tooltip="type your answer here">
                                <i class="small material-icons prefix left ">create</i>
                                <input id="answer" type="text" class="validate" style="font-size:25px">
                              <label for="answer">Answer</label>
                            </div>
                        </div>
                            <button class="btn waves-effect waves-grey grey-text text-darken-4 yellow darken-2" type="submit" name="action" style="font-size:18px;margin-left:160px;text-transform:none;">Submit
