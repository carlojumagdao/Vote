...
class formLoader {
	...
	private function element_single_line_text($field)
	{
	    ...
	    if($id == "member_id"){
	    	...
	    	$html .= sprintf('<input type="text" name="%s" id="%s" class="validate %s" value="%s">', $id, $id, $required,$this->strMemMname);
	    } else if($id == "last_name"){
	    	$html .= sprintf('<input type="text" name="%s" id="%s" class="validate %s" value="%s">', $id, $id, $required,$this->strMemLname);
	    } else if($id == "email"){
	    	$html .= sprintf('<input type="text" name="%s" id="%s" class="validate %s" value="%s">', $id, $id, $required,$this->strMemEmail);
	    } 
	    else {
	    	$intCounter = 0;
	    	$blHasData = false;
